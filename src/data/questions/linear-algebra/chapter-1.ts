...
const questions: QuizQuestion[] = [
  {
    ...
    correctAnswer: 0,
    explanation: "A matrix is defined as a rectangular array of numbers, symbols, or expressions arranged in rows and columns. A matrix with m rows and n columns is called an m × n matrix."
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: "For matrix multiplication, if A is m×n and B is n×p, then the product AB is m×p. Here, A is 3×4 and B is 4×2, so the product AB is 3×2."
  },
  {
    id: 4,
    question: "What is the result of multiplying matrix A = [[2, 3], [4, 5]] by scalar 3?",
    options: [
      "[[6, 9], [12, 15]]",
      "[[5, 6], [7, 8]]",
      "[[2, 3, 2, 3], [4, 5, 4, 5]]",
    ...
    correctAnswer: 0,
    explanation: "Scalar multiplication multiplies each element of the matrix by the scalar. So 3×[[2, 3], [4, 5]] = [[3×2, 3×3], [3×4, 3×5]] = [[6, 9], [12, 15]]."
  },
  {
    id: 5,
    ...
    correctAnswer: 0,
    explanation: "For matrix multiplication AB to be defined, the number of columns in A must equal the number of rows in B. If A is m×n and B is n×p, then the product AB is m×p."
  },
  {
    id: 6,
    ...
    correctAnswer: 0,
    explanation: "Matrix multiplication is generally not commutative, meaning that for most matrices A and B, AB ≠ BA. In fact, sometimes one product is defined while the other isn't, depending on the dimensions."
  },
  {
    id: 7,
    question: "What is the determinant of the 2×2 matrix [[3, 4], [5, 7]]?",
    options: [
      "1",
      "0",
      "-1",
    ...
    correctAnswer: 0,
    explanation: "For a 2×2 matrix [[a, b], [c, d]], the determinant is ad - bc. So for [[3, 4], [5, 7]], the determinant is 3×7 - 4×5 = 21 - 20 = 1."
  },
  {
    id: 8,
    ...
    correctAnswer: 0,
    explanation: "The transpose of a matrix swaps its rows and columns. So the transpose of A = [[1, 2, 3], [4, 5, 6]] is A^T = [[1, 4], [2, 5], [3, 6]]."
  },
  {
    id: 9,
  ...
  {
    id: 12,
    question: "What is the inverse of the 2×2 matrix [[2, 1], [1, 1]]?",
    options: [
      "[[1, -1], [-1, 2]]",
      "[[2, 1], [1, 1]]",
      "[[-1, 1], [1, -2]]",
    ...
    correctAnswer: 0,
    explanation: "For a 2×2 matrix [[a, b], [c, d]], the inverse is (1/(ad-bc))[[d, -b], [-c, a]]. For [[2, 1], [1, 1]], the determinant is 2×1 - 1×1 = 1, so the inverse is (1/1)[[1, -1], [-1, 2]] = [[1, -1], [-1, 2]]."
  },
  {
    id: 13,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: "A symmetric matrix is a square matrix that equals its transpose: A = A^T. This means a_ij = a_ji for all indices i and j."
  },
  {
    id: 15,
    question: "What is the determinant of a 3×3 matrix with a row of all zeros?",
    options: [
      "0",
      "1",
      "-1",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: "The determinant of a product of matrices equals the product of their determinants: det(AB) = det(A) × det(B). This is a multiplicative property of determinants."
  },
  {
    id: 17,
    ...
    correctAnswer: 0,
    explanation: "A skew-symmetric matrix is a square matrix that equals the negative of its transpose: A = -A^T. This means a_ij = -a_ji for all indices i and j."
  },
  {
    id: 18,
  ...
  {
    id: 21,
    question: "The cofactor C_ij of an element a_ij in a matrix is defined as:",
    options: [
      "C_ij = (-1)^(i+j) × M_ij, where M_ij is the minor",
      "C_ij = a_ij × M_ij, where M_ij is the minor",
      "C_ij = (-1)^(i+j) × a_ij",
      "C_ij = M_ij, where M_ij is the minor"
    ],
    correctAnswer: 0,
    explanation: "The cofactor C_ij of an element a_ij is defined as C_ij = (-1)^(i+j) × M_ij, where M_ij is the minor of a_ij (determinant of the submatrix obtained by deleting the i-th row and j-th column)."
  },
  {
    id: 22,
    question: "Using Sarrus' rule, what is the determinant of [[1, 2, 3], [4, 5, 6], [7, 8, 9]]?",
    options: [
      "0",
      "1",
      "45",
    ...
    correctAnswer: 0,
    explanation: "Using Sarrus' rule: (1×5×9 + 2×6×7 + 3×4×8) - (3×5×7 + 1×6×8 + 2×4×9) = (45 + 84 + 96) - (105 + 48 + 72) = 225 - 225 = 0."
  },
  {
    id: 23,
    ...
    correctAnswer: 0,
    explanation: "The adjoint (or adjugate) of a matrix A is the transpose of the cofactor matrix of A. It is used in the formula A^(-1) = (1/det(A)) × adj(A) to find the inverse of A."
  },
  {
    id: 24,
    question: "For a 3×3 matrix, how many cofactors are there?",
    options: [
      "9",
      "3",
      "6",
    ...
    correctAnswer: 0,
    explanation: "For an n×n matrix, there are n^2 cofactors, one for each element of the matrix. So for a 3×3 matrix, there are 3^2 = 9 cofactors."
  },
  {
    id: 25,
